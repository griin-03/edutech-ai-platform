...
// 1. TÁCH NỘI DUNG CHÍNH RA COMPONENT RIÊNG
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <Card className="max-w-md w-full shadow-2xl border-0 overflow-hidden rounded-3xl bg-white">
        <CardContent className="p-0">
           ...
           <div className="p-8 flex flex-col items-center gap-6 min-h-[400px] justify-center text-center">
              {status === "LOADING" ? (
                 ...
                 <>
                    <div className="relative group p-4 border-2 border-dashed border-blue-300 rounded-2xl bg-white shadow-lg">
                       <QRCodeSVG value={mobileUrl} size={220} level={"H"} includeMargin={true} />
                    ...
                    <div className="space-y-2">
                       ...
                       <p className="text-sm text-slate-500 max-w-[250px] mx-auto text-center">
...
// 2. EXPORT CHÍNH VỚI SUSPENSE (GIẢI PHÁP CHO LỖI RENDER)
